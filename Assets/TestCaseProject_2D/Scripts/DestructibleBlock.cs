...
public class DestructibleBlock : MonoBehaviour
{
    ...
    public GameObject collectiblePrefab; // Oluþturduðumuz ganimet prefabý
    [Range(0f, 100f)] public float dropChance = 10f; // %35 düþme ihtimali
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        if (blockHealth <= 0)
        {
            ...
            // Blok patladýðýnda parçacýk efekti çýkýyor
            ...
            if (collectiblePrefab != null)
            {
                ...
                if (roll <= dropChance)
                {
                    ...
                    if (itemScript != null)
                    {
                        int randomType = Random.Range(0, 4); // 4 farklý ganimet çeþidi
