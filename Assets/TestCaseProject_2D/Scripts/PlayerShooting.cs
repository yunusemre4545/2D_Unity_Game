...
public class PlayerShooting : MonoBehaviour
{
    ...
    public float fireRate = 1f; // Baþlangýç ateþ etme sýklýðý
    private float nextFireTime;
    public float minFireRate = 0.08f; // Ulaþýlabilecek en yüksek atýþ hýzý sýnýrý (Oyun GG olmasýn diye)

    [Header("Buff & Limit Deðiþkenleri")]
    public float bulletSpeed = 7f;
    public int bulletCount = 1;
    public int maxBulletCount = 10; // Ekranda üst üste yýðýlýp oyunu kasmamasý için max top sýnýrý!

    [Header("Roket Ayarlarý")]
    public GameObject rocketPrefab;
    private float lastTapTime = 0f;
    public float doubleTapThreshold = 0.3f; // Çift týklama süresi
    ...
    void Update()
    {
        ...
        // Çift týklama (Double Tap) algýlama
    ...
    // Atýþ Hýzý Buff'ý (FireRateBoost ganimeti için)
    public void IncreaseSpeed()
    {
        fireRate -= 0.15f;

        // Minimum sýnýrýn altýna düþmesini engelliyoruz (Oyun çökmesin / aþýrý hýzlanmasýn)
    ...
    public void AddRocket(int amount)
    {
        if (GameplayManager.Instance != null)
        {
            ...
            // Eðer GameplayManager içinde UI güncelleyen bir fonksiyonun varsa burada çaðýrabilirsin
